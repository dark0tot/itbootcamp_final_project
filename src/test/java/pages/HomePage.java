...
public class HomePage extends BasePage {
    ...
    public WebElement getBtnES() {
        return getDriver().findElement(btnES);
    }

    public WebElement getBtnEN() {
        return getDriver().findElement(btnEN);
    }

    public WebElement getBtnFR() {
        return getDriver().findElement(btnFR);
    }

    public WebElement getH1() {
        return getDriver().findElement(h1);
    }
    ...
    public void openSingUpLink() {
        getSingUpLink().click();
    }

    public void selectES() {
        getLanguageBtn().click();
        getDriverWait().until(ExpectedConditions.visibilityOf(getBtnES())); // Explicit waiter needed to recognize witch language to select
        getBtnES().click();
    }
