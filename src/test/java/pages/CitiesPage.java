...
public class CitiesPage extends LoggedHomePage {
    ...
    public WebElement getEditItemTextBox() {
        return getDriver().findElement(editItemTextBox);
    }

    public WebElement getEditItemSaveBtn() {
        return getDriver().findElement(editItemSaveBtn);
    }

    public WebElement getColumnName() {
        return getDriver().findElement(columnName);
    }
